...
const GROUP_RULES = {
  "smith-et-al-2007-tr-007": [
    [[0, 1], [0]], [[2], [1]],
  ],
  "smith-et-al-2007-tr-012": [
    [[0], [0]], [[1], [1]], [[2], [2, 3]],
  ],
  "smith-et-al-2007-tr-032": [
    [[0, 1], [0]],
  ],
  "smith-et-al-2007-tr-038": [
    [[0], [0]], [[1], [1]], [[2], [2]], [[3], [3]], [[4, 5], [4]],
  ],
  "smith-et-al-2007-tr-039": [
    [[0], [0]], [[1, 2], [1]], [[3], [2]], [[4], [3]],
    [[5, 6], [4]], [[7], [5]],
  ],
};
...
function reviewedSentenceSplit(value) {
  const replacements = [
    ...
    ["J.A.", "JAABBREVIATIONTOKEN"],
    ["J.S.", "JSABBREVIATIONTOKEN"],
  ];
...
function main() {
  ...
  if (resolved.entries.length !== 106) {
    throw new Error(`${SLUG}: expected 106 aligned paragraphs, found ${resolved.entries.length}`);
  }
  ...
  alignment.sentence_alignment_note =
    `All ${pairCount} sentence pairs were checked against the complete bilingual paragraph blocks for meaning, order, omissions, citations, numbers, qualification language, masculinity/independence/help-seeking distinctions, and source fidelity. Sentence-boundary mismatch blocks were regrouped manually; all 59 references remain verbatim.`;
